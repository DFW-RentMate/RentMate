...
export default function HeroMapSection() {
  return (
    ...
    >
      {/* 1. 3D로 바닥에 깔린 지도 */}
      <div
        className="w-[600px] h-[450px] rounded-[40px] shadow-2xl relative border-4 border-white/20"
        style={{
      ...
      <div className="absolute top-[10%] right-[5%] z-20 w-[450px]">
        <div className="relative">
          {/* 뒤쪽 카드 */}
          <div className="absolute top-0 left-0 w-[420px] h-[110px] bg-white rounded-3xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-gray-100">
            {/* 📸 매물 사진 대용 주황색 사각형 (왼쪽으로 이동: left-10 -> left-6) */}
            <div className="absolute top-4 left-6 w-[76px] h-[76px] bg-[#ffe4de] rounded-2xl"></div>
          ...
          <div className="absolute top-9 left-11 z-20 w-[420px] h-[110px] bg-white rounded-3xl shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-gray-100 p-4 flex items-center gap-4">
